...
// 中級者向け — 描画パイプラインアクセス
// ============================================================================
namespace gx { class Renderer3D; class Camera3D; class PostEffectPipeline; class InputManager; }

/// @brief 3Dレンダラーを取得する
gx::Renderer3D&         GetRenderer3D();

/// @brief 3Dカメラを取得する
gx::Camera3D&           GetCamera3D();

/// @brief ポストエフェクトパイプラインを取得する
gx::PostEffectPipeline& GetPostEffects();

/// @brief 入力マネージャーを取得する
gx::InputManager&       GetInputManager();
