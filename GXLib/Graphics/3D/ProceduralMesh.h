...
public:
    ...
    uint32_t AddVertex(const XMFLOAT3& position, const XMFLOAT3& normal,
                       const XMFLOAT2& texcoord, const XMFLOAT4& tangent = {0,0,0,1});
...
private:
    std::vector<Vertex3D_PBR> m_vertices;
