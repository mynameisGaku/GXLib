...
{
    XMFLOAT3 position    = { 0.0f, 0.0f, 0.0f };  ///< 現在位置
    XMFLOAT3 prevPosition = { 0.0f, 0.0f, 0.0f };  ///< 前フレーム位置
    XMFLOAT3 acceleration = { 0.0f, 0.0f, 0.0f };  ///< 加速度
...
struct ClothCollider
{
    ...
    XMFLOAT3 position       = { 0.0f, 0.0f, 0.0f };  ///< 位置（球の中心/カプセル始点）
    float    radius         = 1.0f;                     ///< 半径
    XMFLOAT3 capsuleEnd     = { 0.0f, 0.0f, 0.0f };   ///< カプセル終点
...
private:
    ...
    std::vector<ClothCollider>  m_colliders;
