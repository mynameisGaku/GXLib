...
struct ShaderProgramDesc
{
    gx::WString vsPath;
    gx::WString psPath;
    gx::WString vsEntry = L"VSMain";
    gx::WString psEntry = L"PSMain";
...
public:
    ...
    void DrawMesh(const GPUMesh& mesh, const Matrix4x4& worldMatrix);
    ...
    void SetFog(FogMode mode, const Vector3& color, float start, float end, float density = 0.01f);
...
private:
    ...
    gx::HashMap<int, ShaderPipeline> m_customShaders;
