...
public:
    ...
    /// @param width 幅（片側）
    /// @param color 頂点カラー
    void AddPoint(const Vector3& position, const Vector3& up,
...
private:
    ...
    void BuildVertices(gx::Vector<TrailVertex>& outVerts) const;
    ...
    // リングバッファ方式
    gx::Vector<TrailPoint> m_points;       ///< ポイントのリングバッファ
