...
struct VehicleConfig
{
    ...
    std::vector<float> gearRatios = { -3.5f, 0.0f, 3.8f, 2.2f, 1.5f, 1.0f, 0.75f }; ///< ギア比 (R, N, 1, 2, 3, 4, 5)
...
struct VehicleState
{
    ...
    std::vector<WheelState> wheels;           ///< 各ホイールの状態
};
...
private:
    ...
    std::vector<WheelConfig>    m_wheelConfigs;
