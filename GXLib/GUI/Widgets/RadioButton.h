...
public:
    ...
    /// @param value 値文字列
    void SetValue(const gx::String& value) { m_value = value; }

    /// @brief 値文字列を取得する
    /// @return 値文字列
    const gx::String& GetValue() const { return m_value; }
...
private:
    ...
    gx::WString m_text;                ///< ラベルテキスト
    gx::String m_value;                ///< onValueChangedに渡される値文字列
