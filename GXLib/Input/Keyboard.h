...
private:
    gx::Array<bool, k_KeyCount> m_currentState = {};   ///< 現在フレームのキー状態
    gx::Array<bool, k_KeyCount> m_previousState = {};  ///< 前フレームのキー状態
    gx::Array<bool, k_KeyCount> m_rawState = {};       ///< メッセージから受信した生の状態（Update時にcurrentへコピー）
};
