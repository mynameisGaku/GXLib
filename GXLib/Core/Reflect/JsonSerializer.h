...
public:
    ...
    /// @return JSON文字列
    static std::string Serialize(const TypeInfo& type, const void* obj);
    ...
    /// @param json JSON文字列
    /// @return 成功時 true
    static bool Deserialize(const TypeInfo& type, void* obj, const std::string& json);
    ...
    static std::string SerializeProperty(const PropertyMeta& prop, const void* obj);
    ...
    /// @return 成功時 true
    static bool DeserializeProperty(const PropertyMeta& prop, void* obj, const std::string& value);
};
