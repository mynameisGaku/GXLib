...
public:
    ...
    static gx::Vector<uint8_t> Encrypt(const void* data, size_t size,
    ...
    static gx::Vector<uint8_t> Decrypt(const void* data, size_t size,
                                         const uint8_t key[32], const uint8_t iv[16]);
    ...
    static gx::Array<uint8_t, 32> SHA256(const void* data, size_t size);
