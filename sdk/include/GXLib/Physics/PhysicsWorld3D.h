...
public:
    ...
    /// @param maxDistance 最大距離
    /// @return ヒットしたボディのリスト
    gx::Vector<SweepResult> SphereCast(const Vector3& origin, float radius,
    ...
    /// @param maxDistance 最大距離
    /// @return ヒットしたボディのリスト
    gx::Vector<SweepResult> BoxCast(const Vector3& origin, const Vector3& halfExtents,
    ...
    gx::Vector<OverlapResult> OverlapSphere(const Vector3& center, float radius);
    ...
    /// @param rotation ボックスの回転
    /// @return オーバーラップしたボディのリスト
    gx::Vector<OverlapResult> OverlapBox(const Vector3& center, const Vector3& halfExtents,
