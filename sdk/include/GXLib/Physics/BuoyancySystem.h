...
struct BuoyancyBody
{
    ...
    gx::Vector<Vector3> samplePoints;       ///< サンプルポイント (ローカル座標)
};
...
public:
    ...
    void AddBody(uint32_t id, float mass, float volume, const gx::Vector<Vector3>& samplePoints);
...
private:
    ...
    gx::Vector<BuoyancyBody> m_bodies;
