...
struct WindowDesc
{
    gx::WString title  = L"GXLib Application";   ///< ウィンドウタイトル
...
public:
    ...
    void SetTitle(const gx::WString& title);
...
private:
    ...
    gx::Vector<std::function<bool(HWND, UINT, WPARAM, LPARAM)>> m_messageCallbacks;    ///< メッセージフックリスト
};
