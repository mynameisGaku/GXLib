...
public:
    ...
    const gx::Vector<GestureEvent>& GetGestures() const { return m_gestures; }
...
private:
    ...
    gx::Vector<TouchPoint> m_touches;
    gx::HashMap<uint32_t, TouchTracker> m_trackers;
    gx::Vector<GestureEvent> m_gestures;
    ...
    gx::HashMap<int, bool> m_gestureEnabled;
