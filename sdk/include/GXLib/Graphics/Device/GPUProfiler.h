...
public:
    ...
    const gx::Vector<ScopeResult>& GetResults() const { return m_results; }
...
private:
    ...
    struct FrameData
    {
        ...
        gx::Vector<ScopeEntry> scopes;
    };

    FrameData m_frameData[k_BufferCount];
    gx::Vector<ScopeResult> m_results;
    ...
    gx::Vector<int> m_scopeStack;  ///< アクティブスコープのインデックススタック
