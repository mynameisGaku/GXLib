...
private:
    ...
    gx::WString m_shaderPath;
    gx::WString m_rayGenExport;
    gx::WString m_closestHitExport;
    gx::WString m_missExport;
    gx::WString m_shadowMissExport;
    gx::WString m_hitGroupName;
