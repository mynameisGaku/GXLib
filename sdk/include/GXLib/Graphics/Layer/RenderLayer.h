...
public:
    ...
    /// @param height レイヤー高さ
    /// @return 成功でtrue
    bool Create(ID3D12Device* device, const gx::String& name,
    ...
    bool IsPostFXEnabled() const { return m_postFXMask != PostFXFlag::None; }
    void SetPostFXEnabled(bool e) { m_postFXMask = e ? PostFXFlag::All : PostFXFlag::None; }
    PostFXFlag GetPostFXMask() const { return m_postFXMask; }
    void SetPostFXMask(PostFXFlag mask) { m_postFXMask = mask; }
...
private:
    ...
    PostFXFlag m_postFXMask = PostFXFlag::All;
