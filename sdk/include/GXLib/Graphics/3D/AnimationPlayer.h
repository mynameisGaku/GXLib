...
private:
    ...
    gx::Vector<TransformTRS> m_bindPose;         ///< スケルトンのバインドポーズをTRS分解したもの
    gx::Vector<TransformTRS> m_localPose;         ///< 現在のローカルTRS姿勢
    gx::Vector<Matrix4x4>    m_localTransforms;  ///< ローカル変換行列
    gx::Vector<Matrix4x4>    m_globalTransforms;  ///< グローバル変換行列
