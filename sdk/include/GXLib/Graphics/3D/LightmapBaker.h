...
struct LightmapChart
{
    ...
    gx::Vector<LightmapTexel> texelData;        ///< テクセルデータ
...
{
    gx::Vector<LightmapChart> charts;            ///< チャート配列
...
private:
    ...
    gx::Vector<MeshInstance>   m_meshInstances;
    gx::Vector<LightSource>    m_lights;
