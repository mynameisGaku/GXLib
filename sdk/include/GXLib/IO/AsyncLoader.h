...
public:
    ...
    uint32_t Load(const gx::String& path,
...
private:
    ...
    gx::Vector<std::pair<uint32_t, std::shared_ptr<LoadRequest>>> m_pendingQueue;
    gx::Vector<std::shared_ptr<LoadRequest>> m_completedQueue;
    gx::HashMap<uint32_t, LoadStatus> m_statusMap;
